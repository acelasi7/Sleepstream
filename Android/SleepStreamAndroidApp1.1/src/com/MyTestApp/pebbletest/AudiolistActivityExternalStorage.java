...
public class AudiolistActivityExternalStorage extends ListActivity 
{
	
  private Cursor cursor;
  Uri uriExternalSDCard = null;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    try
    {
    uriExternalSDCard = MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
    }
    catch(Exception e)
    {
    	makeToast("Error: Cannot find external storage on your device");
    	return;
    }
    ...
    cursor = getContentResolver().query(uriExternalSDCard, sa_projection, queryFilter, null, null);
